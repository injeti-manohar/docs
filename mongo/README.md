...
-	[`3.4.19-jessie`, `3.4-jessie` (*3.4/Dockerfile*)](https://github.com/docker-library/mongo/blob/5ab118c15c474192dc6ab058e5cb370b73ced636/3.4/Dockerfile)
-	[`3.6.10-stretch`, `3.6-stretch`, `3-stretch` (*3.6/Dockerfile*)](https://github.com/docker-library/mongo/blob/e3d632f0b8c5b979f06ec933eca2a08293161530/3.6/Dockerfile)
-	[`4.0.6-xenial`, `4.0-xenial`, `4-xenial`, `xenial` (*4.0/Dockerfile*)](https://github.com/docker-library/mongo/blob/0a423591d7243256819edc97cef579206d01f6c7/4.0/Dockerfile)
-	[`4.1.7-xenial`, `4.1-xenial`, `unstable-xenial` (*4.1/Dockerfile*)](https://github.com/docker-library/mongo/blob/48ed849349121d0127263e1722f140309e56637f/4.1/Dockerfile)

## Shared Tags

-	`3.4.19`, `3.4`:
	-	[`3.4.19-jessie` (*3.4/Dockerfile*)](https://github.com/docker-library/mongo/blob/5ab118c15c474192dc6ab058e5cb370b73ced636/3.4/Dockerfile)
-	`3.6.10`, `3.6`, `3`:
	-	[`3.6.10-stretch` (*3.6/Dockerfile*)](https://github.com/docker-library/mongo/blob/e3d632f0b8c5b979f06ec933eca2a08293161530/3.6/Dockerfile)
-	`4.0.6`, `4.0`, `4`, `latest`:
	-	[`4.0.6-xenial` (*4.0/Dockerfile*)](https://github.com/docker-library/mongo/blob/0a423591d7243256819edc97cef579206d01f6c7/4.0/Dockerfile)
-	`4.1.7`, `4.1`, `unstable`:
	-	[`4.1.7-xenial` (*4.1/Dockerfile*)](https://github.com/docker-library/mongo/blob/48ed849349121d0127263e1722f140309e56637f/4.1/Dockerfile)
...
```console
$ docker run -d --name some-mongo -e MONGO_INITDB_ROOT_USERNAME=mongoadmin -e MONGO_INITDB_ROOT_PASSWORD=secret amd64/mongo

$ docker run -it --rm --link some-mongo:mongo amd64/mongo mongo --host mongo -u mongoadmin -p secret --authenticationDatabase admin some-db
> db.getName();
some-db
```
